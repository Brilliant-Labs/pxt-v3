...
export function showFirmwareDialogAsync() {
    ...
    return core.confirmAsync({
        ...
        jsx: <div className="ui form">
            ...
            <div>
                <button onClick={() => window.open("bBoardFirmware2_08.hex", "_blank")} className="ui button icon icon-and-text primary purple attached">
                    Click to Download bBoardFirmware2_08.hex
                </button>
            </div>
        </div>,
    }).then(res => {
